// CREDIT https://github.com/Jacajack/misc/tree/master/linux/picom-rounded-borders
#version 330
...
vec4 window_shader()
{
    ...
    vec4 with_corners = add_rounded_corners(c, texcoord, tex_size, corner_radius, 3);
